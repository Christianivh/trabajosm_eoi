...
En este caso seleccionaríamos 1'066 clientes (2ª columna 367+699), de los que 699 serían éxito. Las métricas asociadas a esta matriz de confusión serían:
...
y el valor donde se alcanza este valor es el que nos va a permitir seleccionar el umbral 5644

```{r umbralKS}
which(BANK_KS$DIFF==KS)
BANK_KS[5095,c("CAMP_DEPOSITOS","prediccion")]
```
...
BANK_KS[8511,c("CAMP_DEPOSITOS","prediccion")]
```

en este caso el umbral seleccionado que maximiza el F1-Score es 0.308060.
